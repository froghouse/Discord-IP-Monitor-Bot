...
from .conftest import (
    assert_config_boolean_defaults,
    assert_config_defaults,
    assert_config_string_defaults,
)
...
class TestAppConfigEnvironmentVariableLoading:
    ...
    def test_load_from_env_required_fields_present(
        self, mock_load_dotenv, minimal_env_config
    ):
    ...
    @patch("ip_monitor.config.load_dotenv")
    def test_load_from_env_comprehensive_all_fields(
        self, mock_load_dotenv, comprehensive_env_config
    ):
