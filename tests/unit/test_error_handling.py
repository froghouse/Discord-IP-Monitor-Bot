...
from ip_monitor.utils.service_health import ServiceHealthMonitor, DegradationLevel
...
class TestGracefulDegradation:
    ...
    async def test_automatic_recovery_from_degradation(self, service_health_monitor):
        ...
        assert current_level in [DegradationLevel.NORMAL, DegradationLevel.MINOR, DegradationLevel.MODERATE]
...
class TestRecoveryMechanisms:
    ...
    async def test_cascading_recovery_prevention(self):
        ...
        def can_attempt_recovery():
            ...
            now = datetime.now()
            recent_recovery_attempts = [
                attempt for attempt in recent_recovery_attempts
