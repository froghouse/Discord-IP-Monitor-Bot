...
class TestIPValidation:
    ...
    def test_is_invalid_ip_addresses(self):
        ...
        for ip in invalid_addresses:
            assert IPService.is_valid_ip(ip) is False, (
                f"Invalid IP {ip} should not be valid"
            )
...
class TestCustomAPIFetching:
    ...
    async def test_fetch_ip_from_custom_api_json_success(
        self, service_with_mock_client, mock_api_config
    ):
        ...
        result = await service_with_mock_client.fetch_ip_from_custom_api(
            mock_api_config
        )
    ...
    async def test_fetch_ip_from_custom_api_json_with_custom_field(
        self, service_with_mock_client, mock_api_config
    ):
    ...
    async def test_fetch_ip_from_custom_api_json_fallback_fields(
        self, service_with_mock_client, mock_api_config
    ):
    ...
    async def test_fetch_ip_from_custom_api_text_response(
        self, service_with_mock_client, mock_api_config
    ):
    ...
    async def test_fetch_ip_from_custom_api_auto_format_json(
        self, service_with_mock_client, mock_api_config
    ):
    ...
    async def test_fetch_ip_from_custom_api_auto_format_text(
        self, service_with_mock_client, mock_api_config
    ):
    ...
    async def test_fetch_ip_from_custom_api_with_headers(
        self, service_with_mock_client, mock_api_config
    ):
    ...
    async def test_fetch_ip_from_custom_api_invalid_json(
        self, service_with_mock_client, mock_api_config
    ):
    ...
    async def test_fetch_ip_from_custom_api_empty_response(
        self, service_with_mock_client, mock_api_config
    ):
    ...
    async def test_fetch_ip_from_custom_api_invalid_ip(
        self, service_with_mock_client, mock_api_config
    ):
    ...
    async def test_fetch_ip_from_custom_api_http_error(
        self, service_with_mock_client, mock_api_config
    ):
        """Test handling of HTTP error response."""
        service_with_mock_client.client.get.side_effect = httpx.HTTPError(
            "Network error"
        )
    ...
    async def test_fetch_ip_from_custom_api_timeout(
        self, service_with_mock_client, mock_api_config
    ):
        """Test handling of request timeout."""
        service_with_mock_client.client.get.side_effect = httpx.TimeoutException(
            "Request timed out"
        )
    ...
    async def test_fetch_ip_from_custom_api_custom_timeout(
        self, service_with_mock_client, mock_api_config
    ):
...
class TestLegacyAPIFetching:
    ...
    async def test_fetch_ip_from_api_json_success(
        self, mock_service_health, service_with_mock_client
    ):
        """Test successful JSON API response."""
        mock_response = Mock()
        mock_response.status_code = 200
        ...
        result = await service_with_mock_client.fetch_ip_from_api(
            "https://api.example.com/ip?format=json"
        )
    ...
    @patch("ip_monitor.ip_service.service_health")
    async def test_fetch_ip_from_api_text_success(
        self, mock_service_health, service_with_mock_client
    ):
    ...
    @patch("ip_monitor.ip_service.service_health")
    async def test_fetch_ip_from_api_json_parse_error(
        self, mock_service_health, service_with_mock_client
    ):
    ...
    @patch("ip_monitor.ip_service.service_health")
    async def test_fetch_ip_from_api_json_key_error(
        self, mock_service_health, service_with_mock_client
    ):
    ...
    @patch("ip_monitor.ip_service.service_health")
    async def test_fetch_ip_from_api_invalid_ip(
        self, mock_service_health, service_with_mock_client
    ):
        """Test handling of invalid IP address in response."""
        mock_response = Mock()
    ...
    @patch("ip_monitor.ip_service.service_health")
    async def test_fetch_ip_from_api_http_error(
        self, mock_service_health, service_with_mock_client
    ):
    ...
    @patch("ip_monitor.ip_service.service_health")
    async def test_fetch_ip_from_api_unexpected_error(
        self, mock_service_health, service_with_mock_client
    ):
    ...
    @patch("ip_monitor.ip_service.service_health")
    async def test_fetch_ip_from_api_text_with_whitespace(
        self, mock_service_health, service_with_mock_client
    ):
...
class TestConcurrentAPIChecking:
    ...
    @patch("ip_monitor.ip_service.ip_api_manager")
    async def test_get_ip_without_circuit_breaker_concurrent_custom_apis(
        self, mock_api_manager, service_with_mock_client
    ):
        ...
        with patch.object(
            service_with_mock_client, "fetch_ip_from_custom_api", side_effect=mock_fetch
        ):
    ...
    async def test_get_ip_without_circuit_breaker_concurrent_legacy_apis(
        self, service_with_legacy_apis
    ):
        ...
        async def mock_fetch_api(api_url):
            ...
            if "api.ipify.org?format=json" in api_url:
                return "203.0.113.1"
            if "ifconfig.me" in api_url:
                return "203.0.113.2"
            return None

        with patch.object(
            service_with_legacy_apis, "fetch_ip_from_api", side_effect=mock_fetch_api
        ):
            result = await service_with_legacy_apis._get_ip_without_circuit_breaker()

        assert result == "203.0.113.1"  # First successful result

    async def test_get_ip_without_circuit_breaker_concurrent_all_fail(
        self, service_with_legacy_apis
    ):
        ...
        with patch.object(
            service_with_legacy_apis, "fetch_ip_from_api", return_value=None
        ):
            result = await service_with_legacy_apis._get_ip_without_circuit_breaker()

        assert result is None

    async def test_get_ip_without_circuit_breaker_concurrent_with_exception(
        self, service_with_legacy_apis
    ):
        ...
        async def mock_fetch_api_with_exceptions(api_url):
            ...
            if "ifconfig.me" in api_url:
                return "203.0.113.1"
            if "api.ipify.org" in api_url and "format=json" not in api_url:
                raise Exception("Timeout")
            return None

        with patch.object(
            service_with_legacy_apis,
            "fetch_ip_from_api",
            side_effect=mock_fetch_api_with_exceptions,
        ):
            result = await service_with_legacy_apis._get_ip_without_circuit_breaker()

        assert result == "203.0.113.1"  # Should get the successful result

    async def test_get_ip_without_circuit_breaker_concurrent_with_cache(
        self, service_with_legacy_apis
    ):
        ...
        with patch.object(
            service_with_legacy_apis,
            "fetch_ip_from_api",
            side_effect=mock_fetch_api_with_cache,
        ):
            result = await service_with_legacy_apis._get_ip_without_circuit_breaker()
    ...
    @patch("ip_monitor.ip_service.ip_api_manager")
    async def test_get_ip_without_circuit_breaker_concurrent_api_save(
        self, mock_api_manager, service_with_mock_client
    ):
...
class TestSequentialAPIChecking:
    ...
    @patch("ip_monitor.ip_service.ip_api_manager")
    async def test_get_ip_without_circuit_breaker_sequential_custom_apis(
        self, mock_api_manager, service_with_mock_client
    ):
    ...
    async def test_get_ip_without_circuit_breaker_sequential_legacy_apis(
        self, service_with_legacy_apis
    ):
    ...
    @patch("ip_monitor.ip_service.ip_api_manager")
    async def test_get_ip_without_circuit_breaker_sequential_all_fail_with_retries(
        self, mock_api_manager, service_with_mock_client
    ):
        ...
        # Mock all API responses to fail
        with patch.object(
            service_with_mock_client, "fetch_ip_from_api", return_value=None
        ):
            result = await service_with_mock_client._get_ip_without_circuit_breaker()
    ...
    @patch("ip_monitor.ip_service.ip_api_manager")
    async def test_get_ip_without_circuit_breaker_sequential_custom_api_save(
        self, mock_api_manager, service_with_mock_client
    ):
...
class TestCircuitBreakerIntegration:
    ...
    async def test_get_public_ip_without_circuit_breaker(
        self, service_without_circuit_breaker
    ):
        """Test get_public_ip without circuit breaker."""
        with patch.object(
            service_without_circuit_breaker,
            "_get_ip_without_circuit_breaker",
            return_value="203.0.113.1",
        ):
    ...
    async def test_get_public_ip_with_circuit_breaker_success(
        self, service_with_circuit_breaker
    ):
        """Test get_public_ip with circuit breaker - successful case."""
        # Mock circuit breaker
        service_with_circuit_breaker.circuit_breaker.get_ip_with_fallback_cache = (
            AsyncMock(return_value="203.0.113.1")
        )
    ...
    async def test_get_public_ip_with_circuit_breaker_same_ip(
        self, service_with_circuit_breaker
    ):
    ...
    async def test_get_public_ip_with_circuit_breaker_new_ip(
        self, service_with_circuit_breaker
    ):
        ...
        service_with_circuit_breaker.circuit_breaker.get_ip_with_fallback_cache = (
            AsyncMock(return_value="203.0.113.2")
        )
    ...
    async def test_get_public_ip_with_circuit_breaker_exception(
        self, service_with_circuit_breaker
    ):
        ...
        service_with_circuit_breaker.circuit_breaker.get_ip_with_fallback_cache = (
            AsyncMock(side_effect=Exception("Circuit breaker error"))
        )
    ...
    async def test_get_public_ip_with_circuit_breaker_exception_no_fallback(
        self, service_with_circuit_breaker
    ):
    ...
    def test_get_circuit_breaker_info_enabled(self, service_with_circuit_breaker):
        ...
        service_with_circuit_breaker.circuit_breaker.get_state = Mock(
            return_value={"state": "CLOSED", "failure_count": 0, "success_count": 5}
        )
...
class TestCacheIntegration:
    ...
    @patch("ip_monitor.ip_service.ip_api_manager")
    async def test_refresh_stale_cache_entries_custom_api(
        self, mock_api_manager, service_with_cache
    ):
        ...
        service_with_cache.cache.get_stale_entries.return_value = [
            mock_entry1,
            mock_entry2,
        ]
        ...
        mock_api_manager.get_api_by_name.side_effect = [
            mock_api_config1,
            mock_api_config2,
        ]
    ...
    async def test_refresh_stale_cache_entries_legacy_api(self, service_with_cache):
        ...
        # Mock fetch responses
        with patch.object(
            service_with_cache, "fetch_ip_from_api", side_effect=["203.0.113.1", None]
        ):
            result = await service_with_cache.refresh_stale_cache_entries()
...
class TestErrorHandlingAndRetryLogic:
    ...
    async def test_retry_logic_eventual_success(self, mock_sleep, service_with_retries):
        ...
        with patch.object(
            service_with_retries, "fetch_ip_from_api", side_effect=mock_fetch_api
        ):
            result = await service_with_retries._get_ip_without_circuit_breaker()
    ...
    async def test_http_timeout_handling(self, service_with_retries):
        ...
        service_with_retries.client.get.side_effect = httpx.TimeoutException(
            "Request timed out"
        )

        result = await service_with_retries.fetch_ip_from_api(
            "https://api.example.com/ip"
        )
    ...
    async def test_connection_error_handling(self, service_with_retries):
        ...
        service_with_retries.client.get.side_effect = httpx.ConnectError(
            "Connection failed"
        )
...
class TestServiceHealthIntegration:
    ...
    @patch("ip_monitor.ip_service.service_health")
    async def test_service_health_success_recording(
        self, mock_service_health, service_with_mock_client
    ):
    ...
    @patch("ip_monitor.ip_service.service_health")
    async def test_service_health_failure_recording_http_error(
        self, mock_service_health, service_with_mock_client
    ):
    ...
    @patch("ip_monitor.ip_service.service_health")
    async def test_service_health_failure_recording_invalid_ip(
        self, mock_service_health, service_with_mock_client
    ):
    ...
    @patch("ip_monitor.ip_service.service_health")
    async def test_service_health_failure_recording_json_error(
        self, mock_service_health, service_with_mock_client
    ):
...
class TestEdgeCasesAndRobustness:
    ...
    async def test_json_response_with_numeric_ip(self, service_with_mock_client):
        ...
        mock_response.json.return_value = {
            "ip": 3405803777
        }  # Numeric representation of 203.0.113.1
        mock_response.raise_for_status = Mock()
...
class TestIntegrationWithMockServer:
    ...
    async def test_fetch_ip_from_json_endpoint(
        self, mock_ip_api_server, service_for_integration
    ):
    ...
    async def test_fetch_ip_from_text_endpoint(
        self, mock_ip_api_server, service_for_integration
    ):
    ...
    async def test_fetch_ip_from_error_endpoint(
        self, mock_ip_api_server, service_for_integration
    ):
    ...
    async def test_fetch_ip_from_slow_endpoint(
        self, mock_ip_api_server, service_for_integration
    ):
    ...
    async def test_full_ip_check_integration(
        self, mock_ip_api_server, service_for_integration
    ):
...
class TestPerformanceCharacteristics:
    ...
    async def test_concurrent_performance(self, performance_service):
        ...
        with patch.object(
            performance_service, "fetch_ip_from_api", side_effect=mock_fetch_api
        ):
    ...
    async def test_resource_cleanup_after_errors(self, performance_service):
        ...
        result = await performance_service.fetch_ip_from_api(
            "https://api.example.com/ip"
        )
