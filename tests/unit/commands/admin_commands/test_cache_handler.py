...
class TestCacheHandler:
    ...
    @pytest.fixture
    def cache_handler(self, mock_client, mock_ip_service, mock_storage, mock_stop_callback, mock_config):
    ...
    async def test_handle_cache_command_no_permissions(self, cache_handler, mock_message):
    ...
    async def test_handle_cache_command_no_args_shows_help(self, cache_handler, mock_message):
    ...
    async def test_handle_cache_command_show_subcommand(self, cache_handler, mock_message, mock_cache_info):
    ...
    async def test_handle_cache_command_clear_subcommand(self, cache_handler, mock_message, mock_cache_info):
    ...
    async def test_handle_cache_command_invalid_subcommand(self, cache_handler, mock_message):
    ...
    async def test_handle_cache_show_enabled(self, cache_handler, mock_message, mock_cache_info):
    ...
    async def test_handle_cache_clear_enabled(self, cache_handler, mock_message, mock_cache_info):
    ...
    async def test_handle_cache_clear_with_namespace(self, cache_handler, mock_message, mock_cache_info):
        """Test cache clear with specific namespace."""
        cache_handler.ip_service.get_cache_info.return_value = mock_cache_info
        cache_handler.ip_service.invalidate_cache.return_value = 5
        
        result = await cache_handler._handle_cache_clear(mock_message, ['clear', 'ip_check'])
        assert result is True
    ...
    async def test_handle_cache_stats_enabled(self, cache_handler, mock_message, mock_cache_info):
        """Test cache stats when cache is enabled."""
        cache_handler.ip_service.get_cache_info.return_value = mock_cache_info
        
        with patch('ip_monitor.commands.admin_commands.cache_handler.get_cache') as mock_get_cache:
    ...
    async def test_handle_cache_stats_import_error(self, cache_handler, mock_message, mock_cache_info):
    ...
    async def test_handle_cache_cleanup_enabled(self, cache_handler, mock_message, mock_cache_info, mock_cache_instance):
    ...
    async def test_handle_cache_refresh_enabled(self, cache_handler, mock_message, mock_cache_info):
    ...
    async def test_handle_cache_refresh_no_stale_entries(self, cache_handler, mock_message, mock_cache_info):
    ...
    async def test_cache_clear_different_namespaces(self, cache_handler, mock_message, mock_cache_info):
        ...
        for namespace in test_namespaces:
            result = await cache_handler._handle_cache_clear(mock_message, ['clear', namespace])
            assert result is True
