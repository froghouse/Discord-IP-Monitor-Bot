...
class TestQueueHandler:
    ...
    @pytest.fixture
    def queue_handler(self, mock_client, mock_ip_service, mock_storage, mock_stop_callback, mock_config):
    ...
    def mock_message_queue(self):
        ...
        with patch('ip_monitor.commands.admin_commands.queue_handler.message_queue') as mock_queue:
    ...
    async def test_handle_command_queue_command(self, queue_handler, mock_message, mock_message_queue):
    ...
    async def test_handle_queue_command_no_permissions(self, queue_handler, mock_message):
    ...
    async def test_handle_queue_command_no_args_shows_status(self, queue_handler, mock_message, mock_message_queue):
    ...
    async def test_handle_queue_command_clear_subcommand(self, queue_handler, mock_message, mock_message_queue):
    ...
    async def test_handle_queue_command_retry_subcommand(self, queue_handler, mock_message, mock_message_queue):
    ...
    async def test_handle_queue_command_start_subcommand(self, queue_handler, mock_message, mock_message_queue):
    ...
    async def test_handle_queue_command_stop_subcommand(self, queue_handler, mock_message, mock_message_queue):
    ...
    async def test_handle_queue_command_invalid_subcommand(self, queue_handler, mock_message, mock_message_queue):
    ...
    async def test_handle_queue_command_exception(self, queue_handler, mock_message, mock_message_queue):
    ...
    async def test_show_queue_status_complete_data(self, queue_handler, mock_message, mock_message_queue):
        """Test show_queue_status with complete data."""
        result = await queue_handler._show_queue_status(mock_message)
        assert result is True
        mock_message_queue.get_queue_status.assert_called_once()

    async def test_show_queue_status_minimal_data(self, queue_handler, mock_message, mock_message_queue):
    ...
    async def test_handle_queue_clear_success(self, queue_handler, mock_message, mock_message_queue):
    ...
    async def test_handle_queue_clear_no_messages(self, queue_handler, mock_message, mock_message_queue):
    ...
    async def test_handle_queue_retry_success(self, queue_handler, mock_message, mock_message_queue):
    ...
    async def test_handle_queue_retry_no_failed_messages(self, queue_handler, mock_message, mock_message_queue):
    ...
    async def test_handle_queue_start_not_processing(self, queue_handler, mock_message, mock_message_queue):
    ...
    async def test_handle_queue_start_already_processing(self, queue_handler, mock_message, mock_message_queue):
    ...
    async def test_handle_queue_stop_processing(self, queue_handler, mock_message, mock_message_queue):
    ...
    async def test_handle_queue_stop_not_processing(self, queue_handler, mock_message, mock_message_queue):
