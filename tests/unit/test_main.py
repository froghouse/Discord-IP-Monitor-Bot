...
class TestMainEntryPoint:
    ...
    async def test_main_successful_startup(self, mock_setup_logging, mock_app_config, mock_bot, mock_logger):
        ...
        mock_config_class.load_from_file.assert_called_once_with("bot_config.json", config_instance)
    ...
    async def test_main_configuration_loading_error(self, mock_setup_logging, mock_app_config, mock_bot, mock_logger):
    ...
    async def test_main_bot_initialization_error(self, mock_setup_logging, mock_app_config, mock_bot, mock_logger):
    ...
    async def test_main_bot_run_error(self, mock_setup_logging, mock_app_config, mock_bot, mock_logger):
    ...
    async def test_main_keyboard_interrupt(self, mock_setup_logging, mock_app_config, mock_bot, mock_logger):
    ...
    async def test_main_file_configuration_loading(self, mock_setup_logging, mock_app_config, mock_bot, mock_logger):
    ...
    async def test_main_logging_setup_called_first(self, mock_setup_logging, mock_app_config, mock_bot, mock_logger):
    ...
    async def test_main_bot_receives_correct_config(self, mock_setup_logging, mock_app_config, mock_bot, mock_logger):
    ...
    async def test_main_error_logging_includes_exception_info(self, mock_setup_logging, mock_app_config, mock_bot, mock_logger):
    ...
    async def test_main_multiple_exception_scenarios(self, mock_setup_logging, mock_app_config, mock_bot, mock_logger):
...
class TestMainScriptExecution:
    ...
    def test_main_script_execution_success(self, mock_asyncio_run, mock_exit, mock_main_function):
    ...
    def test_main_script_execution_with_error(self, mock_asyncio_run, mock_exit, mock_main_function):
...
class TestMainErrorHandling:
    ...
    async def test_main_configuration_file_error(self, mock_dependencies):
        ...
        mocks['config_class'].load_from_file.side_effect = Exception("File config error")
