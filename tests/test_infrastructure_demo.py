...
class TestPerformanceUtilities:
    ...
    def test_performance_benchmark_sync(self):
        ...
        metrics = benchmark.benchmark_sync_operation(
            test_operation,
            iterations=50
        )
...
class TestDatabaseCleanup:
    ...
    def test_performance_database_cleanup(self):
        ...
        with performance_test_database("perf_cleanup_test", initial_records=50) as db_path:
            import sqlite3
            conn = sqlite3.connect(db_path)
            cursor = conn.cursor()
...
class TestIntegratedExample:
    ...
    async def test_comprehensive_performance_scenario(self):
        ...
        with performance_test_database("comprehensive_test", initial_records=10) as db_path:
