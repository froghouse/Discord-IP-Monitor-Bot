...
class IPAddressGenerator:
    ...
    def generate_ip_list(count: int, public_only: bool = True) -> List[str]:
        ...
        generator = IPAddressGenerator.generate_public_ip if public_only else IPAddressGenerator.generate_private_ip
...
class IPHistoryGenerator:
    ...
    def generate_ip_history(
        ...
        for i in range(count):
            ...
            time_variance = random.randint(-time_interval_minutes//2, time_interval_minutes//2)
...
class DiscordDataGenerator:
    ...
    def generate_username() -> str:
        ...
        adjectives = ["Cool", "Fast", "Smart", "Brave", "Lucky", "Swift", "Bright", "Bold"]
...
class APIResponseGenerator:
    ...
    @staticmethod
    def generate_json_response(ip: Optional[str] = None, field: str = "ip") -> Dict[str, Any]:
    ...
    @staticmethod
    def generate_text_response(ip: Optional[str] = None) -> str:
    ...
    @staticmethod
    def generate_complex_json_response(ip: Optional[str] = None) -> Dict[str, Any]:
    ...
    @staticmethod
    def generate_error_response(status_code: int = 500, message: str = "Internal Server Error") -> Dict[str, Any]:
...
class DatabaseRecordGenerator:
    ...
    @staticmethod
    def generate_current_ip_record(ip: Optional[str] = None) -> Tuple[str, str]:
    ...
    def generate_bulk_test_data(
        ...
        return {
            ...
            "ip_history": DatabaseRecordGenerator.generate_ip_history_records(history_count)
        }
...
class MessageQueueDataGenerator:
    ...
    def generate_message_queue_batch(
        ...
        for _ in range(count):
            ...
            message = MessageQueueDataGenerator.generate_queued_message(priority=priority)
